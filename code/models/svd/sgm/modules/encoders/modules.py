...
from models.svd.sgm.modules.autoencoding.regularizers import DiagonalGaussianRegularizer
from models.svd.sgm.modules.diffusionmodules.model import Encoder
from models.svd.sgm.modules.diffusionmodules.openaimodel import Timestep
from models.svd.sgm.modules.diffusionmodules.util import (extract_into_tensor,
                                              make_beta_schedule)
from models.svd.sgm.modules.distributions.distributions import DiagonalGaussianDistribution
from models.svd.sgm.util import (append_dims, autocast, count_params, default,
    ...
    def forward(
        ...
        for embedder in self.embedders:
            ...
            for emb in emb_out:
                ...
                # print(f"{embedder.input_key} -> {out_key}")
