...
from models.svd.sgm.modules.attention import SpatialTransformer
from models.svd.sgm.modules.diffusionmodules.util import (avg_pool_nd, conv_nd, linear,
                                              normalization,
                                              timestep_embedding, zero_module)
from models.svd.sgm.modules.video_attention import SpatialVideoTransformer
from models.svd.sgm.util import exists
...
class TimestepEmbedSequential(nn.Sequential, TimestepBlock):
    ...
    def forward(
        ...
        from models.diffusion.video_model import VideoResBlock
