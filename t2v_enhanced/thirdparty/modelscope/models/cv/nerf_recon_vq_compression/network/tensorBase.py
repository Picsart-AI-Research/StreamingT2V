...
class MLPRender_Fea(torch.nn.Module):
    ...
    def __init__(self, inChanel, viewpe=6, feape=6, featureC=128):
        ...
        self.mlp = torch.nn.Sequential(layer1,
                                       torch.nn.ReLU(inplace=True), layer2,
...
class TensorBase(torch.nn.Module):
    ...
    def init_render_func(self, shadingMode, pos_pe, view_pe, fea_pe, featureC,
        ...
        if shadingMode == 'MLP_PE':
            self.renderModule = MLPRender_PE(self.app_dim, view_pe, pos_pe,
                                             featureC).to(device)
        elif shadingMode == 'MLP_Fea':
            self.renderModule = MLPRender_Fea(self.app_dim, view_pe, fea_pe,
                                              featureC).to(device)
    ...
    def updateAlphaMask(self, gridSize=(200, 200, 200)):
        ...
        ks = 3
        alpha = F.max_pool3d(
            alpha, kernel_size=ks, padding=ks // 2,
    ...
    def filtering_rays(self,
        ...
        for idx_chunk in idx_chunks:
            ...
            if bbox_only:
                ...
                mask_inbbox = (self.alphaMask.sample_alpha(xyz_sampled).view(
